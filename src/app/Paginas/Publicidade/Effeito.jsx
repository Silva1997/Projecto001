...
hora do dia
       ...
       <p style={{textAlign:"start" ,color:'white'}}>Com o GSTCF você recebe sua encomenda<br/> onde estiver,
        a qualquer hora</p>
        <div style={{ display: "flex", flexDirection: "row", gap: "10px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "row", gap: "10px", }}>
            <Inventory2Icon className='f_social_icon' /><p id='frasesPrincipal'  style={{color:'white',marginRight:"10px"}} >Embalagem mantém o <br />bolo intacto</p>
      ...
      >
        <SwiperSlide className="Merd"><img src={imagem} id="Imagem" alt="Foto" /></SwiperSlide>
        <SwiperSlide className="Merd"><img src={imagem1} id="Imagem" alt="Foto" /></SwiperSlide>
        <SwiperSlide className="Merd"><img src={imagem2} id="Imagem" alt="Foto" /></SwiperSlide>
        <SwiperSlide className="Merd"><img src={imagem3} id="Imagem" alt="Foto" /></SwiperSlide>
        <SwiperSlide className="Merd"><img src={imagem4} id="Imagem" alt="Foto" /></SwiperSlide>
        <SwiperSlide className="Merd"><img src={imagem5} id="Imagem" alt="Foto" /></SwiperSlide>
