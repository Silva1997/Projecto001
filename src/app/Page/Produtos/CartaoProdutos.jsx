...
import ModalPersonalizar from './PersonalizarProdutos'
//
            ...
            <div className='div320'>
                ...
                <Card sx={{
                    ...
                    <CardContent className='Cartao320' style={{backgroundColor:"white"}} >
                        ...
                        {/* <input type="radio" name="P" id="" value={"P"} />
                        <input type="radio" name="P" id="" value={"G"} />
                        ...
                        {productQuantity > 0 ?
                            ...
                            : <> <button style={{ backgroundColor:"white",textDecoration: "none",
                             border: "none", padding: "2px 4px", borderRadius: "2px 3px",
                             marginLeft: "105px" }} onClick={() => { cart.addOneToCart(product.id, product) }}>
                             <AddCircleIcon style={{ color: "red" }} /></button> 
                             <ModalPersonalizar/>
                              </>
                        }
                    </CardContent>
