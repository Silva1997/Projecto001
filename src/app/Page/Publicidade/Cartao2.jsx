...
<Card sx={{ maxWidth: 200 ,margin: 2 }} >
      ...
      />
      <span style={{backgroundColor:"#f03c",padding:"4px 4px",
      color:"#EEE",borderRadius:"12px 12px ", fontSize:"8pt",
     position:"relative",top:"-250px", left:"-60px"}}>desconto7%</span>
      <CardContent >
